...
public class AudioPickAdapter extends BaseAdapter<AudioFile, AudioPickAdapter.AudioPickViewHolder> {
    ...
    public AudioPickViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.picker_layout_item_audio_pick, parent, false);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Util.detectIntent(mContext, intent)) {
                    ...
                    ToastUtil.getInstance(mContext).showToast(mContext.getString(R.string.picker_no_audio_play_app));
                }
            }
        });
    }
