...
import com.picker.adapter.VideoPickAdapter;
...
public class VideoPickActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picker_activity_video_pick);
    ...
    private void initView() {
        ...
        GridLayoutManager layoutManager = new GridLayoutManager(this, Picker.config.column);
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(Picker.RESULT_PICK_VIDEO, mSelectedList);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case Picker.REQUEST_CODE_TAKE_VIDEO:
