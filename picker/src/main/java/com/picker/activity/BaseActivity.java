...
import com.picker.FolderListHelper;
...
public abstract class BaseActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        isNeedFolderList = getIntent().getBooleanExtra(Picker.SHOW_FOLDER_LIST, false);
        if (isNeedFolderList) {
    ...
    private void readExternalStorage() {
        ...
        if (isGranted) {
            ...
            EasyPermissions.requestPermissions(this, getString(R.string.picker_rationale_storage),
