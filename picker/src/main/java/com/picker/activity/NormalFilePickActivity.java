...
import com.picker.adapter.NormalFilePickAdapter;
...
public class NormalFilePickActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picker_activity_file_pick);
        mMaxNumber = getIntent().getIntExtra(Picker.MAX_COUNT, Picker.DEFAULT_MAX_COUNT);
        mSuffix = getIntent().getStringArrayExtra(Picker.SUFFIX);
        initView();
    }
    ...
    private void initView() {
        ...
        rl_done.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putParcelableArrayListExtra(Picker.RESULT_PICK_FILE, mSelectedList);
